          ...
          <Toolbar sx={{ px: { xs: 2, md: 3 } }}>
            ...
            <Box display="flex" alignItems="center">
              <IconButton
                ...
                sx={{ 
                  mr: 1,
                  bgcolor: alpha(customColors.primary, 0.08),
                  '&:hover': {
                    bgcolor: alpha(customColors.primary, 0.15),
                  }
                }}
              >
                <ArrowBack sx={{ color: customColors.primary }} />
              </IconButton>
              <Stack>
                <Typography variant="h6" component="h1" sx={{ fontWeight: 'bold', color: customColors.textPrimary }}>
                  {complaint?.title}
                </Typography>
                <Breadcrumbs aria-label="breadcrumb" sx={{ mt: 0.5 }}>
                  ...
                  >
                    <Typography color="text.secondary" fontSize="inherit">إدارة الشكاوى</Typography>
                  </Link>
                  <Typography color="text.secondary" sx={{ fontWeight: 'medium', fontSize: '0.85rem' }}>
            ...
            <Box>
              <Chip
                ...
                sx={{ 
                  fontWeight: 'bold', 
                  mr: 1, 
                  boxShadow: `0 2px 5px ${alpha(customColors.error, 0.2)}`,
                  borderRadius: '20px',
                  px: 0.5,
                  bgcolor: 'white',
              ...
              <Tooltip title="إرسال إشعار داخل التطبيق">
                <IconButton
                  color="info"
                  onClick={openInAppNotificationDialog}
                  sx={{ 
                    mr: 1,
                    bgcolor: alpha(customColors.info, 0.1),
                    color: customColors.info,
                    '&:hover': {
                      bgcolor: alpha(customColors.info, 0.2),
                    }
                  }}
              ...
              <Tooltip title="إرسال إشعار خارج التطبيق">
                <IconButton
                  color="primary"
                  onClick={openPushNotificationDialog}
                  sx={{ 
                    mr: 1,
              ...
              >
                <MoreVert sx={{ color: customColors.darkGrey }} />
              </IconButton>
            ...
            <Grid item xs={12} md={4} lg={3}>
              ...
              >
                <Box 
                  sx={{ 
                    p: 2, 
                    bgcolor: alpha(getStatusColor(complaint.status), 0.9),
                    color: 'white',
                    textAlign: 'center'
                  }}
                >
              ...
              >
                      ...
                      >
                        ...
                        <Box sx={{ 
                          ...
                          bgcolor: response.isAdmin 
                            ? alpha(customColors.primary, 0.05)
                            : alpha(customColors.success, 0.05),
                          borderRadius: 2,
                          p: 2,
                          boxShadow: '0 1px 5px rgba(0,0,0,0.05)',
                          border: `1px solid ${response.isAdmin 
                            ? alpha(customColors.primary, 0.2)
                            : alpha(customColors.success, 0.2)}`
                        }}>
                          <Box sx={{ 
                            display: 'flex', 
                            justifyContent: 'space-between', 
                ...
                {complaint.status !== 'closed' ? (
                  <Box 
                    sx={{ 
                      p: 2,
                      borderTop: `1px solid ${customColors.cardBorder}`,
                      bgcolor: 'white'
                    }}
                  >
                    {responseSuccess && (
                  ...
                  <Box sx={{ p: 2, bgcolor: alpha(customColors.error, 0.05), borderTop: `1px solid ${customColors.cardBorder}` }}>
                    <Alert
                      severity="info"
                      sx={{ borderRadius: 2 }}
                      action={
